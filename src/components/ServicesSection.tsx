      ...
      >
        {services.map((service) => (
          <motion.div
            ...
            className="p-6 bg-gradient-to-br from-emerald-900/50 to-emerald-950/50 rounded-lg shadow-md shadow-emerald-900/50 hover:shadow-xl hover:shadow-emerald-700/50 transition-all border border-emerald-800"
